...
from .views import post_validate_writing_answer, fetch_test, fetch_test_types, fetch_all_tests, fetch_test_info, fetch_type_display_names, post_validate_answers
...
urlpatterns = [
    ...
    path("api/selection/<str:skill>/", fetch_all_tests, name="get_all_Skill_tests"),
    path("api/selection/<str:skill>/<str:test_type>/", fetch_all_tests, name="get_all_type_tests"),
